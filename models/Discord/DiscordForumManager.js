...
class DiscordForumManager {
  ...
  async handleForum() {
    ...
    handle_channel(config.discord_channel_admin_complaints, 'https://forums.yogstation.net/forums/admin-admin-complaints.146/index.rss', /<title>((.+) - report by .+)<\/title>\r?\n +<pubDate>.+<\/pubDate>\n +<link>(.+)<\/link>/g, 3, 1, 1, -1);
