...
class DiscordForumManager {
  ...
  async handleForum() {
    ...
    handle_channel(config.discord_channel_player_complaints, 'https://forums.yogstation.net/index.php?forums/player-complaints.3/index.rss', /<item>\s+<title>(.+)<\/title>[^]+?<link>(.+)<\/link>/g, 2, 1, 3);
