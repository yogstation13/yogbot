...
class DiscordForumManager {
  ...
  async handleForum() {
    ...
    handle_channel(config.discord_channel_player_complaints, 'https://forums.yogstation.net/index.php?forums/player-complaints.3/index.rss', /<item>\s+<title>(.+report by.+)<\/title>[^]+?<link>(.+)<\/link>/g, 2, 1, 3);
    handle_channel(config.discord_channel_admin_complaints, 'https://forums.yogstation.net/index.php?forums/administrator-complaints.4/index.rss', /<item>\s+<title>(.+report by.+)<\/title>[^]+?<link>(.+)<\/link>/g, 2, 1, 3, -1);
    handle_channel(config.discord_channel_staff_applications, 'https://forums.yogstation.net/index.php?forums/administrator-applications.6/index.rss', /<item>\s+<title>(.+application)<\/title>[^]+?<link>(.+)<\/link>/g, 2, 1, 3);
    handle_channel(config.discord_channel_mentor_applications, 'https://forums.yogstation.net/index.php?forums/mentor-applications.206/index.rss', /<item>\s+<title>(.+application)<\/title>[^]+?<link>(.+)<\/link>/g, 2, 1, 3, 2);
