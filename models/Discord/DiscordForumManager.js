...
class DiscordForumManager {
  ...
  async handleForum() {
    ...
    handle_channel(config.discord_channel_admin_complaints, 'https://forums.yogstation.net/index.php?forums/administrator-complaints.4/index.rss', /<item>\s+<title>(.+)<\/title>[^]+?<link>(.+)<\/link>/g, 2, 1, 3, -1);
