...
class DiscordForumManager {
  ...
  async handleForum() {
    ...
    handle_channel(config.discord_channel_ban_appeals, 'https://forums.yogstation.net/index.php?forums/ban-appeals.2/index.rss', /<a href="(.+)" class="link link--internal">(Ban Appeal - .+ - (.+) \[.+ ban])<\/a><\/div>]]><\/content:encoded/g, 1, 2, 3);
